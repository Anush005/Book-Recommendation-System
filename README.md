# ShelfPick - Book Recommendation App

## Project info

A book recommendation application built with React, TypeScript, and Tailwind CSS.
...
Simply clone this repo and use your preferred IDE to edit the code.
